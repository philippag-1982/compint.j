...
public class MultiplyBenchmark {
    ...
    private static class Args {
        ...
        private static final Int8[] INT_8 = parse(STRING, Int8::fromString, Int8.class);
...
//    @Param({"1", "4", "16", "999"})
    ...
    @Benchmark
    public void multiplySimpleInt8(Blackhole blackhole) {
        perform(Args.INT_8, Int8::multiplySimple, blackhole);
    }
    ...
    @Benchmark
    public void parseAndMultiplySimpleInt8(Blackhole blackhole) {
        parseAndPerform(Args.STRING, Int8::fromString, Int8::multiplySimple, blackhole);
    }
    ...
    @Benchmark
    public void multiplyKaratsubaInt8(Blackhole blackhole) {
        BinaryOperator<Int8> operator = (lhs, rhs) -> Int8.multiplyKaratsuba(lhs, rhs, karatsubaThreshold);
        perform(Args.INT_8, operator, blackhole);
    }
    ...
    @Benchmark
    public void parseAndMultiplyKaratsubaInt8(Blackhole blackhole) {
        BinaryOperator<Int8> operator = (lhs, rhs) -> Int8.multiplyKaratsuba(lhs, rhs, karatsubaThreshold);
        parseAndPerform(Args.STRING, Int8::fromString, operator, blackhole);
    }
    ...
    @Benchmark
    public void parallelMultiplyKaratsubaInt8(Blackhole blackhole) {
        BinaryOperator<Int8> operator = (lhs, rhs) -> Int8.parallelMultiplyKaratsuba(lhs, rhs, karatsubaThreshold, maxDepth, forkJoinPool);
        perform(Args.INT_8, operator, blackhole);
    }
    ...
    @Benchmark
    public void parseAndParallelMultiplyKaratsubaInt8(Blackhole blackhole) {
        BinaryOperator<Int8> operator = (lhs, rhs) -> Int8.parallelMultiplyKaratsuba(lhs, rhs, karatsubaThreshold, maxDepth, forkJoinPool);
        parseAndPerform(Args.STRING, Int8::fromString, operator, blackhole);
    }
